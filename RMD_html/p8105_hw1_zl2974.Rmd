...
In this dataset, we've seen a `r nrow(penguins)`  *  `r ncol(penguins)` size, in which contains column's variables eg. `r names(penguins)`. And the following is the detailed descriptive statistics of penguins data.
